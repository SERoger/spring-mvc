	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-4" style="padding: 30px; text-align: center">
				<div
					style="background-color: white; height: 600px; width: 500px; padding: 20px; border-radius: 10px 120px/120px; box-shadow: 0 3px 10px rgb(0 0 0/ 0.2);">
					<h2 style="color: #046a78">Signup</h2>
					<form action="login" method="POST">
						<p><%="Welcome dear user"%></p>
						<div class="mb-3">
							<label class="form-label">Full Name</label> <input type="text"
								name="fullName" class="form-control" style="text-align: center">
						</div>
						<div class="mb-3">
						...
						<div class="d-grid gap-2">
							...
							<p>
								<a href="/" class="link-primary"
									style="color: #046a78; border: 0px">I have account already</a>
							</p>
						</div>
					</form>
				</div>
